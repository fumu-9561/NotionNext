...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '浮木', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '干中学', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.fumuuu.xyz', // 网站地址
  ...
  HOME_BANNER_IMAGE: 'https://pica.zhimg.com/100/v2-9141a42360fbb2a126d84b65d3ec392e_qhd.jpg',
